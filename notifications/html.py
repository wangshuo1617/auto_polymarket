...
def generate_report_meta_footer(meta):
    ...
    return (
        ...
        'border-radius:8px; padding:16px; margin-top:40px; font-size:12px; line-height:1.6;">'
        f'{rows}'
        '</div>'
    )


def generate_html_template(data, meta=None):
    return f"""
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<body>
    <div class="container">
        ...
        {generate_report_meta_footer(meta)}
