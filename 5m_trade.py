...
class FiveMinuteUpDownTrader:
    ...
    def __init__(
        ...
        risk_min_stake_ratio: float = 0.30,
        risk_max_stake_ratio: float = 1.5,
        confidence_boost_enabled: bool = True,
        confidence_boost_ge_095: float = 1.3,
        stake_cap_very_high: float = 0.20,
        stake_cap_high: float = 0.50,
        stake_cap_medium_high: float = 0.70,
        medium_high_threshold: float = 0.45,
        risk_w_price: float = 0.15,
        risk_w_direction: float = 0.35,
        risk_w_stability: float = 0.50,
