...
# Time range (required)
START_TS_SEC="${START_TS_SEC:-1772613373}"
END_TS_SEC="${END_TS_SEC:-1773383418}"
...
PLATEAU_SL_DELTA="${PLATEAU_SL_DELTA:-0.2}"
WALK_FORWARD="${WALK_FORWARD:-1}"
WF_TRAIN_DAYS="${WF_TRAIN_DAYS:-5}"
WF_TEST_DAYS="${WF_TEST_DAYS:-2}"
WF_STEP_DAYS="${WF_STEP_DAYS:-1}"
...
DB_PATH="${DB_PATH:-${SQLITE_DB_PATH:-tmp/trade.sqlite3}}"
